...
const TRANSLATIONS = {
  de: {
    ...
    roastery:          'Rösterei',
    bean_type:         'Bohnentyp',
    bean_type_arabica: 'Arabica',
    bean_type_robusta: 'Robusta',
    bean_type_blend:   'Blend',
    ...
    import_desc:       'Es können nur Gaggiuino-JSON-Shot-Exporte importiert werden.',
    import_format:     'Erwartet werden Felder wie <code>duration</code>, <code>datapoints[]</code> und optional <code>profile.name</code>.',
    import_only_json:  'Bitte nur JSON-Dateien hochladen.',
    import_gaggiuino_only: 'Nur Gaggiuino-Shot-Exporte werden unterstützt.',
    import_assign_bean: 'Bohne für den Import (optional)',
    import_preview:    'Import-Vorschau',
    show_curve:        'Kurve anzeigen',
    curve_loaded:      'Kurve geladen',     'Format: <code>{"shots":[{"grind_size":20,"extraction_time":27,"brew_weight":36}]}</code>',
  ...
  en: {
    ...
    import_title:      'JSON Import',
    import_desc:       'Only Gaggiuino JSON shot exports can be imported.',
    import_format:     'Expected fields include <code>duration</code>, <code>datapoints[]</code> and optional <code>profile.name</code>.',
    import_only_json:  'Please upload JSON files only.',
    import_gaggiuino_only: 'Only Gaggiuino shot exports are supported.',
    import_assign_bean: 'Assign bean to import (optional)',
    import_preview:    'Import preview',
    show_curve:        'Show curve',
    curve_loaded:      'Curve loaded',     'Format: <code>{"shots":[{"grind_size":20,"extraction_time":27,"brew_weight":36}]}</code>',
